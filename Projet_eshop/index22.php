...
<form id="form1" method="POST" name="form">
    <select  name="choixCat" onchange="sub1();">
        <?php
...
<form id="form2" method="POST" name="form" onchange="sub2();">
...
<?php if (isset($_POST["choixCat"]) && isset($_POST["choixMar"])) { ?>
    <table border="1" width="80%" align="center">
    <?php
    $prod = Produit::fetchAllByCategorieAndMarque(Categorie::fetch($_POST["choixCat"]), Marque::fetch($_POST["choixMar"]));
